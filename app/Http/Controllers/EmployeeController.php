...
class EmployeeController extends Controller {
 ...
 private function validated(Request $r, ?Employee $e=null){
  $rules=[
   ...
   'biometric_code'=>['nullable','string','max:50','regex:/^[A-Za-z0-9_-]+$/',Rule::unique('employees','biometric_code')->ignore($e?->id)],
   ...
   'phone'=>['required','string','max:16','regex:/^\+?[0-9]{10,15}$/'],
   ...
   'city'=>['nullable','string','max:100'], 'state'=>['nullable','string','max:100'], 'country'=>['nullable','string','max:100'],
   'postal_code'=>['nullable','string','max:20','regex:/^[A-Za-z0-9 -]+$/'],
   'emergency_contact_name'=>['nullable','string','max:191'], 'emergency_contact_relationship'=>['nullable','string','max:100'],
   'emergency_contact_phone'=>['nullable','string','max:16','regex:/^\+?[0-9]{10,15}$/'],
   'bank_name'=>['nullable','string','max:191'], 'account_holder_name'=>['nullable','string','max:191'],
   'account_number'=>['nullable','string','max:100','regex:/^[A-Za-z0-9 -]+$/'], 'bank_identifier_code'=>['nullable','string','max:100','regex:/^[A-Za-z0-9-]+$/'],
   'bank_branch'=>['nullable','string','max:191'], 'tax_id'=>['nullable','string','max:100'], 'base_salary'=>['nullable','numeric','min:0','max:999999999999.99'],

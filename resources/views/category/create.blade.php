                                            ...
                                            <div class="col-md-6">
                                                <div class="fv-row mb-3">
                                                    ...
                                                    <select class="form-control form-control-sm form-control-solid" name="is_display_products">
                                                        <option value="0" {{ old('is_display_products', '0') === '0' ? 'selected' : '' }}>No</option>
                                                        <option value="1" {{ old('is_display_products') === '1' ? 'selected' : '' }}>Yes</option>
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="fv-row mb-3">
                                                    ...
                                                    <select class="form-control form-control-sm form-control-solid" name="is_menu">
                                                        <option value="0" {{ old('is_menu', '0') === '0' ? 'selected' : '' }}>No</option>
                                            ...
                                            <div class="col-md-6">
                                                <div class="fv-row mb-3">
                                                    ...
                                                    <select class="form-control form-control-sm form-control-solid" name="is_slider_bottom">
                                                        <option value="0" {{ old('is_slider_bottom', '0') === '0' ? 'selected' : '' }}>No</option>
                                                        <option value="1" {{ old('is_slider_bottom') === '1' ? 'selected' : '' }}>Yes</option>
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="fv-row mb-3">
                                                    ...
                                                    <select class="form-control form-control-sm form-control-solid" name="is_feature">
                                                        <option value="0" {{ old('is_feature', '0') === '0' ? 'selected' : '' }}>No</option>

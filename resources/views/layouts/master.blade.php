				...
				<div class="aside-menu flex-column-fluid">
					...
					<div class="hover-scroll-overlay-y my-5 my-lg-5" id="kt_aside_menu_wrapper" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_aside_logo, #kt_aside_footer" data-kt-scroll-wrappers="#kt_aside_menu" data-kt-scroll-offset="0">
						...
						<div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_aside_menu" data-kt-menu="true">
							...
							@if($sidebarUser->user_type === 'agent')
							<div class="menu-item">
							...
							<div class="menu-item">
								<a class="menu-link {{ request()->routeIs('marketing-settings.*') ? 'active' : '' }}" href="{{ route('marketing-settings.edit') }}">
									<span class="menu-icon"><span class="svg-icon svg-icon-2"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"><path opacity=".3" d="M4 5h16v14H4V5Z" fill="black"/><path d="m5 17 4-5 3 3 3-5 4 7H5ZM7 8a2 2 0 1 0 0-4 2 2 0 0 0 0 4Z" fill="black"/></svg></span></span>
									<span class="menu-title">Marketing</span>
								</a>
							</div>
							<div data-kt-menu-trigger="click" class="menu-item menu-accordion {{ request()->routeIs('reports.*') ? 'here show' : '' }}">
								<span class="menu-link">
									<span class="menu-icon"><span class="svg-icon svg-icon-2"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"><path opacity=".3" d="M4 3h16v18H4V3Z" fill="black"/><path d="M7 17h2v-5H7v5Zm4 0h2V7h-2v10Zm4 0h2V9h-2v8Z" fill="black"/></svg></span></span>
								...
								<div class="menu-sub menu-sub-accordion menu-active-bg">
									...
									<div class="menu-item">
										<a class="menu-link {{ request()->route('report') === $reportKey ? 'active' : '' }}" href="{{ route('reports.show', $reportKey) }}">
											<span class="menu-bullet"><span class="bullet bullet-dot"></span></span>
											<span class="menu-title">{{ $reportLabel }}</span>
										</a>
									</div>
									@endforeach
								</div>
							...
							<div class="menu-item">
								<a class="menu-link {{ request()->routeIs('admin-newsletter.*') ? 'active' : '' }}" href="{{ route('admin-newsletter.index') }}">
									<span class="menu-icon"><span class="svg-icon svg-icon-2"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"><path opacity=".3" d="M3 5h18v14H3V5Z" fill="black"/><path d="m3 6 9 7 9-7v3l-9 7-9-7V6Z" fill="black"/></svg></span></span>
									<span class="menu-title">Newsletter Subscribers</span>
								</a>
							</div>
							<div class="menu-item">
								<a class="menu-link {{ request()->routeIs('career-*', 'create-career') ? 'active' : '' }}" href="{{ route('career-list') }}">
									<span class="menu-icon"><span class="svg-icon svg-icon-2"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"><path opacity=".3" d="M3 7h18v13H3V7Z" fill="black"/><path d="M9 4h6a2 2 0 0 1 2 2v1h-2V6H9v1H7V6a2 2 0 0 1 2-2Zm-6 7h18v3H3v-3Z" fill="black"/></svg></span></span>
									<span class="menu-title">Career Management</span>
								</a>
							</div>
							<div class="menu-item">
								<a class="menu-link" href="{{ route('sitemap') }}" target="_blank" rel="noopener">
									<span class="menu-icon"><span class="svg-icon svg-icon-2"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"><path opacity=".3" d="M4 3h16v5H4V3Zm0 13h7v5H4v-5Zm9 0h7v5h-7v-5Z" fill="black"/><path d="M11 8h2v4h5v4h-2v-2H8v2H6v-4h5V8Z" fill="black"/></svg></span></span>
									<span class="menu-title">View Sitemap</span>
								</a>
							</div>
							@endif
							--}}
								...
								<div class="menu-sub menu-sub-accordion menu-active-bg">
									...
									<div class="menu-item">
										<a class="menu-link {{ request()->routeIs('transfers-*') ? 'active' : '' }}" href="{{ route('transfers-index') }}">
											<span class="menu-bullet"><span class="bullet bullet-dot"></span></span><span class="menu-title">Transfers</span>
										</a>
									</div>
			...
			<div data-kt-menu-trigger="click" class="menu-item menu-accordion {{ request()->routeIs('awards*', 'promotion-*', 'transfers-*', 'warnings-*', 'resignations-*', 'termination-types-*', 'terminations-*', 'complaint-types-*', 'complaints-*') ? 'here show' : '' }}">
				...
				<div class="menu-sub menu-sub-accordion menu-active-bg">
					...
					<div class="menu-item"><a class="menu-link {{ request()->routeIs('resignations-*') ? 'active' : '' }}" href="{{ route('resignations-index') }}"><span class="menu-bullet"><span class="bullet bullet-dot"></span></span><span class="menu-title">Resignations</span></a></div>
							...
							@if($canSeeRoute('outlet-location-list'))
							<div class="menu-item">
							...
							@if($canSeeRoute('product-color-list') || $canSeeRoute('product-size-list'))
							<div data-kt-menu-trigger="click" class="menu-item menu-accordion {{ request()->routeIs('product-color-*', 'product-size-*') ? 'show' : '' }}">
								...
								<div class="menu-sub menu-sub-accordion menu-active-bg">
									@if($canSeeRoute('product-color-list'))
									<div class="menu-item">
									...
									@endif
									@if($canSeeRoute('product-size-list'))
									<div class="menu-item">
							...
							@if($canSeeRoute('shipping-method-list'))
							<div class="menu-item">

...
Route::group(['middleware' => ['auth', 'check-permission']], function () {
	...
	Route::get('/indicator-categories', [IndicatorCategoryController::class, 'index'])->name('indicator-categories-index')->middleware(['check-permission']);
	Route::post('/indicator-categories', [IndicatorCategoryController::class, 'store'])->name('indicator-categories-store');
	Route::put('/indicator-categories/{indicatorCategory}', [IndicatorCategoryController::class, 'update'])->name('indicator-categories-update');
	Route::patch('/indicator-categories/{indicatorCategory}/toggle', [IndicatorCategoryController::class, 'toggle'])->name('indicator-categories-toggle');
	Route::delete('/indicator-categories/{indicatorCategory}', [IndicatorCategoryController::class, 'destroy'])->name('indicator-categories-destroy');
	Route::get('/indicators', [PerformanceIndicatorController::class, 'index'])->name('indicators-index')->middleware(['check-permission']);
	Route::post('/indicators', [PerformanceIndicatorController::class, 'store'])->name('indicators-store');
	Route::put('/indicators/{indicator}', [PerformanceIndicatorController::class, 'update'])->name('indicators-update');
	Route::patch('/indicators/{indicator}/toggle', [PerformanceIndicatorController::class, 'toggle'])->name('indicators-toggle');
	Route::delete('/indicators/{indicator}', [PerformanceIndicatorController::class, 'destroy'])->name('indicators-destroy');
